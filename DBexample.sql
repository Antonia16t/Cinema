...
--
-- Gazdă: 127.0.0.1
-- Timp de generare: mai 25, 2021 la 06:57 PM
...
(1, 'Tarta Antonia', 'Administrator', 'AdmA', 'AdmA', '0764199093', 18, 1),
...
(8, 'Adam Mădălina', 'Client', 'mada123', 'Mădă', '0745324156', 0, 0),
(9, 'Cosbuc Daniela', 'Client', 'danielaa', 'Danii', '0789324534', 0, 0),
(10, 'Gavrea Ioana', 'Client', 'Ioa.43', 'Ioa', '0764746453', 0, 0);
...
--
ALTER TABLE `locuri`
  MODIFY `idl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
